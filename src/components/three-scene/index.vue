<template>
  <div class="three-scene" ref="three-scene" onselectstart="return false;" v-show="true">
    <div @pointerdown="
      (e) => {
        e.stopPropagation();
      }
  ...
  methods: {
    ...
    loadScene() {
      scene = new RunScene({
        ...
        // path: "./assets/s.ltc",
        path: "https://3d-editor-2-1303915342.cos.ap-shanghai.myqcloud.com/202401091017276788341001202411.lt",
    ...
    async setBgc() {
      ...
      // backgroudDom.style.width = "50%";
      // backgroudDom.style.height = "50%";
...
:deep(.bgc) {
  z-index: 20000;
  pointer-events: none;
  background: url("./../../assets/img/scene-mask.png");
}
